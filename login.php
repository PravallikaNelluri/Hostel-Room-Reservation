...
<div class="container">
	<div class="row justify-content-center">
		...
		<div class="col-lg-8 px-4 pb-4">
								<h2 class="page-title text-info">Admin Login </h2>
								<br>
								<br>
								<form class="form-submit" method="POST" action="loginaction.php" >
									<label for="" class="text-uppercase text-sm"><b>Email</b></label>
						...
						<div class="text-center text-dark">
							<a href="change.php" class="text-danger" style="padding-left:200px;"><u>Change Password</u></a>
						</div>
					</div>
				</div>
						</div>
